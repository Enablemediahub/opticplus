...
ALTER TABLE `bank_balance` ADD PRIMARY KEY (`id`);
ALTER TABLE `bank_balance` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `bank_deposits` ADD PRIMARY KEY (`id`);
ALTER TABLE `bank_deposits` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
CREATE TABLE IF NOT EXISTS `billing_frames` (
  `id` int(11) NOT NULL,
...
ALTER TABLE `billing_frames` ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_billing_frame` (`billing_id`,`frame_code_id`),
  ADD KEY `billing_id` (`billing_id`);
ALTER TABLE `billing_frames` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `branch_locations` ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `branch_name` (`branch_name`);
ALTER TABLE `branch_locations` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

CREATE TABLE IF NOT EXISTS `bsmi_transactions` (
  `id` int(11) NOT NULL,
  `billing_id` int(11) NOT NULL,
...
ALTER TABLE `bsmi_transactions` ADD PRIMARY KEY (`id`),
...
ALTER TABLE `bsmi_transactions` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `debt_payments` ADD PRIMARY KEY (`id`),
  ADD KEY `debt_id` (`debt_id`),
  ADD KEY `idx_payment_date` (`payment_date`),
  ADD KEY `recorded_by` (`recorded_by`);
ALTER TABLE `debt_payments` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `debt_reminders` ADD PRIMARY KEY (`id`),
  ADD KEY `debt_id` (`debt_id`),
  ADD KEY `idx_reminder_date` (`reminder_date`),
  ADD KEY `idx_status` (`status`);
ALTER TABLE `debt_reminders` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
CREATE TABLE IF NOT EXISTS `employees_comprehensive` (
  `id` int(11) NOT NULL,
  `staff_id` varchar(20) DEFAULT NULL,
...
ALTER TABLE `employees_comprehensive` ADD PRIMARY KEY (`id`),
...
ALTER TABLE `employees_comprehensive` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `glasses_prescriptions` ADD PRIMARY KEY (`patient_id`);
ALTER TABLE `glasses_prescriptions` MODIFY `patient_id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `insurance_claims` ADD PRIMARY KEY (`id`),
  ADD KEY `fk_insurance_claims_billing` (`billing_id`);
ALTER TABLE `insurance_claims` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `inventory_movements` ADD PRIMARY KEY (`id`),
...
ALTER TABLE `inventory_movements` MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
CREATE TABLE IF NOT EXISTS `lens_costs` (
  `id` int(11) NOT NULL,
  `billing_id` int(11) NOT NULL,
...
ALTER TABLE `lens_costs` ADD PRIMARY KEY (`id`),
...
ALTER TABLE `manufacturers` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `memos` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `memo_approvals` ADD PRIMARY KEY (`id`),
  ADD KEY `idx_memo_id` (`memo_id`),
  ADD KEY `idx_approver_id` (`approver_id`);
ALTER TABLE `memo_approvals` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `memo_attachments` ADD PRIMARY KEY (`id`),
  ADD KEY `idx_memo_id` (`memo_id`),
  ADD KEY `idx_uploaded_by` (`uploaded_by`);
ALTER TABLE `memo_attachments` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `patient_documents` ADD PRIMARY KEY (`id`);
ALTER TABLE `patient_documents` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `patient_form_data` ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `folder_id` (`folder_id`,`version`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `idx_status` (`status`);
ALTER TABLE `patient_form_data` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `patient_records` ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_folder_id` (`folder_id`),
  ADD KEY `folder_id` (`folder_id`),
  ADD KEY `idx_status` (`status`),
  ADD KEY `idx_created_at` (`created_at`);
ALTER TABLE `patient_records` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `paye` ADD PRIMARY KEY (`id`);
ALTER TABLE `paye` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `payroll_history` ADD PRIMARY KEY (`id`),
  ADD KEY `idx_employee` (`employee_id`),
  ADD KEY `idx_date` (`pay_year`,`pay_month`);
ALTER TABLE `payroll_history` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `procurements` ADD PRIMARY KEY (`id`);
ALTER TABLE `procurements` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `revenue` ADD PRIMARY KEY (`sale_id`);
ALTER TABLE `revenue` MODIFY `sale_id` int(10) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `salary_advances` ADD PRIMARY KEY (`id`),
  ADD KEY `idx_employee` (`employee_id`),
  ADD KEY `idx_status` (`status`),
  ADD KEY `idx_deduction` (`deduction_year`,`deduction_month`);
ALTER TABLE `salary_advances` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `sms_templates` ADD PRIMARY KEY (`id`);
ALTER TABLE `sms_templates` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

CREATE TABLE IF NOT EXISTS `ssnit_contributions` (
  `id` int(11) NOT NULL,
  `employee_name` varchar(255) NOT NULL,
...
ALTER TABLE `standard_prices` ADD PRIMARY KEY (`id`);
ALTER TABLE `standard_prices` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `tax_records` ADD PRIMARY KEY (`id`),
  ADD KEY `billing_id` (`billing_id`),
  ADD KEY `transaction_date` (`transaction_date`);
ALTER TABLE `tax_records` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `inventory_movements` ADD CONSTRAINT `fk_inv_movement_product` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE,
